...
- Admin / cross-user session view (`/auth/sessions` is current-user only by design). The current-user Settings session-management UI has now landed — see "Implementation order" step 12.
