...
### Terminal lifecycle, transport, renderers, and UI — see [`docs/spec/terminal.md`](docs/spec/terminal.md)
...
- **Renderer adapters** — four adapters, each documented with package layout, contract, neutrality re-affirmation, dev-lab UI, and production-bundle tree-shaking behavior. Renderer-specific knobs go behind a local `<renderer>Only` escape hatch.
