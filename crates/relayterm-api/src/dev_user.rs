...
//!
//! When real authentication lands, this extractor goes away and is replaced
//! by a session/passkey-derived user. Searches for `DevUser` should then
//! turn up every call site that needs to be re-pointed at the real auth.
//!
//! Intentionally NOT documented as a permanent surface — do not add policy
//! checks or per-route customization here.
