...
| Desktop bundled build — terminal session attach / SSH session launch | ❌ Not exercised | Out of scope for this smoke. Intentionally not tested; deferred to a later slice. |
